$(document).ready( function() {
  ...
  // Drying up edit so it doesn't have to pull these 3 inside
  // the function, see line 73 and 75.
  ...
  $('.edit').on('click', function() {
   ...
   var user = { user: {first_name: userData.first, last_name: userData.last, phone_number: userData.phone }};
   $.ajax(baseUrl + $(this).data('user-id'),
          {
            type: 'PUT',
            data: user,
